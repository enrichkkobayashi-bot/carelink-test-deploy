          ...
          <section className="pdf-avoid-break">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-4 h-[240px]">
              <div className="flex flex-col h-full">
                <label className="text-[10px] font-bold text-indigo-700 block mb-2 truncate">ジェノグラム（家系図）ドロップ可</label>
                <div
                  className="border-2 border-dashed border-indigo-200 rounded-xl flex-1 min-h-0 flex flex-col items-center justify-center relative overflow-hidden bg-indigo-50/50 cursor-pointer hover:bg-indigo-50 transition-colors group"
        ...
        <div className="space-y-4">
          ...
          <section className="pdf-avoid-break">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-8">
              <div className="flex flex-col h-full">
                <label className="text-[10px] font-bold text-indigo-700 block mb-2">間取り図（ドロップ可）</label>
                <div
                  className="border-2 border-dashed border-indigo-200 rounded-xl flex-1 min-h-0 flex items-center justify-center bg-indigo-50/50 cursor-pointer hover:bg-indigo-50 transition-colors group"
